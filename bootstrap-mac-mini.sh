...
#
#   curl -fsSL "https://raw.githubusercontent.com/tejokumar/grok-stocks-alert/main/bootstrap-mac-mini.sh?v=1" | bash
...
echo "[bootstrap] grok-semi-agent Mac mini setup"
